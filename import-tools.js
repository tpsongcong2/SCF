...
<div class="hdr">
  ...
  <div>
    ...
    <div class="co-addr">${co.address||'Tổ 1, P.Mỏ Chè, Tp Sông Công, Thái Nguyên'}</div>
  </div>
</div>
...
const NAV=[
  ...
  {key:'company',icon:'ti-building-community',label:'Giới thiệu công ty'},
  {sec:'Cài đặt'},
  ...
  {key:'utilityexpenses',icon:'ti-bolt',label:'Chi phí điện nước'},
  {sec:'Báo cáo'},
