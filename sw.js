...
const ASSETS = [
  ...
  './user-guide.js',
  './operations.js?v=321',
  './navigation-reports.js?v=320',
  './order-detail.js',
  './delivery-shifts.js',
  './import-tools.js?v=324',
  './auth-workforce.js?v=321',
  './quotations.js',
  './finance.js',
  './delivery-orders.js?v=309',
  './trips.js?v=315',
  './production.js',
  './permissions.js?v=314',
  './permission-settings.js?v=314',
  './app.js?v=324',
  './bootstrap.js?v=311',
  './manifest.json',
  './icon-192.png',
